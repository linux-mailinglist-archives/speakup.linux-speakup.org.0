Return-Path: <speakup+bounces-1054-lists+speakup=lfdr.de@linux-speakup.org>
X-Original-To: lists+speakup@lfdr.de
Delivered-To: lists+speakup@lfdr.de
Received: from befuddled.reisers.ca (befuddled.reisers.ca [206.248.184.127])
	by mail.lfdr.de (Postfix) with ESMTP id 93F747DE7E4
	for <lists+speakup@lfdr.de>; Wed,  1 Nov 2023 23:02:53 +0100 (CET)
Received: by befuddled.reisers.ca (Postfix, from userid 65534)
	id 33129382308; Wed,  1 Nov 2023 18:02:53 -0400 (EDT)
Received: from befuddled.reisers.ca (localhost [127.0.0.1])
	by befuddled.reisers.ca (Postfix) with ESMTP id 1C69738222F
	for <lists+speakup@lfdr.de>; Wed,  1 Nov 2023 18:02:53 -0400 (EDT)
X-Original-To: speakup@linux-speakup.org
Delivered-To: speakup@linux-speakup.org
Received: by befuddled.reisers.ca (Postfix, from userid 65534)
	id 000B7382259; Wed,  1 Nov 2023 18:02:48 -0400 (EDT)
Received: from atlas.bondproducts.com (23-24-6-165-static.hfc.comcastbusiness.net [23.24.6.165])
	by befuddled.reisers.ca (Postfix) with ESMTP id DAFBA382126
	for <speakup@linux-speakup.org>; Wed,  1 Nov 2023 18:02:48 -0400 (EDT)
Received: from users.shellworld.net (users.shellworld.net [50.116.47.71])
	by atlas.bondproducts.com (Postfix) with ESMTP id 76DC640508;
	Wed,  1 Nov 2023 18:02:46 -0400 (EDT)
Received: by users.shellworld.net (Postfix, from userid 1005)
	id 4523D1001B8; Wed,  1 Nov 2023 18:02:46 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
	by users.shellworld.net (Postfix) with ESMTP id 44B0C1001AA;
	Wed,  1 Nov 2023 18:02:46 -0400 (EDT)
Date: Wed, 1 Nov 2023 18:02:46 -0400 (EDT)
...
In-Reply-To: <Pine.LNX.4.64.2311011456240.3180685@users.shellworld.net>
Message-ID: <Pine.LNX.4.64.2311011800050.3180608@users.shellworld.net>
...
> As I recall on the sounding board, irq 2 was default, and we sometimes used 
> seven.  I think 5 was for sound card, irq 4 was for come 1 and 3 and irq3 was 
> for com 2 and com 4 as I recall.  On Tue, 31 Oct 2023, K0LNY ?? wrote:
>
