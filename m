Return-Path: <speakup+bounces-1412-lists+speakup=lfdr.de@linux-speakup.org>
X-Original-To: lists+speakup@lfdr.de
Delivered-To: lists+speakup@lfdr.de
Received: from befuddled.reisers.ca (befuddled.reisers.ca [206.248.184.127])
	by mail.lfdr.de (Postfix) with ESMTP id 71BDBB9AD36
	for <lists+speakup@lfdr.de>; Wed, 24 Sep 2025 18:16:00 +0200 (CEST)
Authentication-Results: befuddled.reisers.ca;
	dkim=pass (1024-bit key; unprotected) header.d=t39smtp-sign001.email header.i=@t39smtp-sign001.email header.a=rsa-sha256 header.s=titan1 header.b=TUBM3Ulw;
	dkim-atps=neutral
Received: by befuddled.reisers.ca (Postfix, from userid 65534)
	id D92D43815E2; Wed, 24 Sep 2025 12:15:59 -0400 (EDT)
Received: from befuddled.reisers.ca (localhost [127.0.0.1])
	by befuddled.reisers.ca (Postfix) with ESMTP id B43B23815AB
	for <lists+speakup@lfdr.de>; Wed, 24 Sep 2025 12:15:59 -0400 (EDT)
X-Original-To: speakup@linux-speakup.org
Delivered-To: speakup@linux-speakup.org
Received: by befuddled.reisers.ca (Postfix, from userid 65534)
	id 7E4E23815A8; Wed, 24 Sep 2025 12:15:52 -0400 (EDT)
Received: from mail122.out.titan.email (mail122.out.titan.email [3.233.41.74])
	by befuddled.reisers.ca (Postfix) with ESMTPS id 9632E3815A3
	for <speakup@linux-speakup.org>; Wed, 24 Sep 2025 12:15:51 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
	by smtp-out.flockmail.com (Postfix) with ESMTP id 1850DE00B6;
	Wed, 24 Sep 2025 16:15:50 +0000 (UTC)
DKIM-Signature: a=rsa-sha256; bh=ItA2kA3rLSPq/PGJhDRIqealH1BWvozopXa75zN2SHk=;
	c=relaxed/relaxed; d=t39smtp-sign001.email;
	h=references:mime-version:from:reply-to:cc:subject:message-id:to:date:from:to:cc:subject:date:message-id:reply-to:references:in-reply-to;
	q=dns/txt; s=titan1; t=1758730549; v=1;
	b=TUBM3Ulwy6ARIh8BcW4lsTafjNFFHi9RZTvj5o605d8Ddm8ZR44kLvryDFY+6zRon1XSGlpV
	EpdUP0UqV+yp33pf2NrkjH7efHaXpw2X68udf2bDZGoTrU3ee2J8cK4kf0lM7C6ODc3dOFCPFgo
	2aObB5l7PFk8chPQKUeDTzkw=
Received: from nucwin10 (unknown [140.228.165.201])
	by smtp-out.flockmail.com (Postfix) with ESMTPA id ADBFCE0050;
	Wed, 24 Sep 2025 16:15:48 +0000 (UTC)
Message-ID: <025601dc2d6e$7e89ba00$01ffa8c0@nucwin10>
...
X-Titan-Src-Out: 1758730549901141288.32108.3270336447740106199@prod-use1-smtp-out1004.
X-CMAE-Score: 0
X-CMAE-Analysis: v=2.4 cv=Sa8NduRu c=1 sm=1 tr=0 ts=68d41935
	...
	a=qPKtzgQbAAAA:8 a=q5txbtUnAAAA:8 a=mdrNs8nvV3E66NtCyIwA:9
