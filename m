Return-Path: <speakup+bounces-1365-lists+speakup=lfdr.de@linux-speakup.org>
X-Original-To: lists+speakup@lfdr.de
Delivered-To: lists+speakup@lfdr.de
Received: from befuddled.reisers.ca (befuddled.reisers.ca [206.248.184.127])
	by mail.lfdr.de (Postfix) with ESMTP id F0386B8229E
	for <lists+speakup@lfdr.de>; Thu, 18 Sep 2025 00:32:34 +0200 (CEST)
Received: by befuddled.reisers.ca (Postfix, from userid 65534)
	id BEF5F382ABC; Wed, 17 Sep 2025 18:32:30 -0400 (EDT)
Received: from befuddled.reisers.ca (localhost [127.0.0.1])
	by befuddled.reisers.ca (Postfix) with ESMTP id A549538266B
	for <lists+speakup@lfdr.de>; Wed, 17 Sep 2025 18:32:30 -0400 (EDT)
X-Original-To: speakup@linux-speakup.org
Delivered-To: speakup@linux-speakup.org
Received: by befuddled.reisers.ca (Postfix, from userid 65534)
	id 926AE3820FA; Wed, 17 Sep 2025 18:32:26 -0400 (EDT)
Received: from atlas.bondproducts.com (atlas.bondproducts.com [23.24.6.165])
	by befuddled.reisers.ca (Postfix) with ESMTP id 772993820FA
	for <speakup@linux-speakup.org>; Wed, 17 Sep 2025 18:32:26 -0400 (EDT)
Received: from users.shellworld.net (users.shellworld.net [50.116.47.71])
	by atlas.bondproducts.com (Postfix) with ESMTP id 2EACD40508;
	Wed, 17 Sep 2025 18:32:19 -0400 (EDT)
Received: by users.shellworld.net (Postfix, from userid 1005)
	id 7965B100B94; Wed, 17 Sep 2025 18:32:16 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
	by users.shellworld.net (Postfix) with ESMTP id 788BB10009F;
	Wed, 17 Sep 2025 18:32:16 -0400 (EDT)
Date: Wed, 17 Sep 2025 18:32:16 -0400 (EDT)
From: Karen Lewellen <klewellen@shellworld.net>
To: Rudy Vener <salt@panix.com>
cc: speakup@linux-speakup.org
Subject: Re: Question about blind CLI use (was Re: "your browser is not
 supported anymore" ...)
In-Reply-To: <aMsboMhBL4klsYZD@panix.com>
Message-ID: <Pine.LNX.4.64.2509171823280.3962820@users.shellworld.net>
...
I have one.
Granted I imagine it starts with knowing such is possible, but I have 
never encountered issues finding, or having custom built, computers for 
my DOS use.
