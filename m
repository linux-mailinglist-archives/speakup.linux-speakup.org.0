Return-Path: <speakup+bounces-544-lists+speakup=lfdr.de@linux-speakup.org>
X-Original-To: lists+speakup@lfdr.de
Delivered-To: lists+speakup@lfdr.de
Received: from befuddled.reisers.ca (befuddled.reisers.ca [206.248.184.127])
	by mail.lfdr.de (Postfix) with ESMTP id B8AC5591D79
	for <lists+speakup@lfdr.de>; Sun, 14 Aug 2022 03:47:55 +0200 (CEST)
Received: by befuddled.reisers.ca (Postfix, from userid 65534)
	id 461CE3847B8; Sat, 13 Aug 2022 21:47:55 -0400 (EDT)
Received: from befuddled.reisers.ca (localhost [127.0.0.1])
	by befuddled.reisers.ca (Postfix) with ESMTP id 1A6653847E8
	for <lists+speakup@lfdr.de>; Sat, 13 Aug 2022 21:47:53 -0400 (EDT)
X-Original-To: speakup@linux-speakup.org
Delivered-To: speakup@linux-speakup.org
Received: by befuddled.reisers.ca (Postfix, from userid 65534)
	id 83B35384789; Sat, 13 Aug 2022 21:47:51 -0400 (EDT)
Received: from server2.shellworld.net (server2.shellworld.net [66.172.12.120])
	by befuddled.reisers.ca (Postfix) with ESMTPS id 3D67E383777
	for <speakup@linux-speakup.org>; Sat, 13 Aug 2022 21:47:51 -0400 (EDT)
Received: by server2.shellworld.net (Postfix, from userid 1005)
	id 7729812132E; Sun, 14 Aug 2022 01:47:20 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
	by server2.shellworld.net (Postfix) with ESMTP id 7632412044B;
	Sat, 13 Aug 2022 21:47:20 -0400 (EDT)
...
Message-ID: <Pine.LNX.4.64.2208132146510.1261053@server2.shellworld.net>
References: <Pine.LNX.4.64.2208112229350.1215855@server2.shellworld.net><1e623296-a020-b22d-52cc-77e3a01c2f61@pobox.com><Pine.LNX.4.64.2208121226001.1229118@server2.shellworld.net>
 ...
 <031101d8af50$8f3d3fb0$80ffa8c0@Win7VM> <Pine.LNX.4.64.2208131618030.1255408@server2.shellworld.net>
...
MIME-Version: 1.0
Content-Type: MULTIPART/MIXED; BOUNDARY="-1404930036-1316854080-1660441640=:1261053"
X-Bogosity: Ham, tests=bogofilter, spamicity=0.000000, version=1.2.5

  This message is in MIME format.  The first part should be readable text,
  while the remaining parts are likely unreadable without MIME-aware tools.

---1404930036-1316854080-1660441640=:1261053
...
> I recall on more than one occasion being provided with documentation wher=
e
