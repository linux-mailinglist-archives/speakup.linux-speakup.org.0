Return-Path: <speakup+bounces-1284-lists+speakup=lfdr.de@linux-speakup.org>
X-Original-To: lists+speakup@lfdr.de
Delivered-To: lists+speakup@lfdr.de
Received: from befuddled.reisers.ca (befuddled.reisers.ca [206.248.184.127])
	by mail.lfdr.de (Postfix) with ESMTP id 72A9BAACD45
	for <lists+speakup@lfdr.de>; Tue,  6 May 2025 20:29:32 +0200 (CEST)
Authentication-Results: befuddled.reisers.ca;
	dkim=pass (1024-bit key; unprotected) header.d=t39smtp-sign001.email header.i=@t39smtp-sign001.email header.a=rsa-sha256 header.s=titan1 header.b=OaDbSKbC;
	dkim-atps=neutral
Received: by befuddled.reisers.ca (Postfix, from userid 65534)
	id C2EB53829A8; Tue, 06 May 2025 14:29:28 -0400 (EDT)
Received: from befuddled.reisers.ca (localhost [127.0.0.1])
	by befuddled.reisers.ca (Postfix) with ESMTP id 9DC38382976
	for <lists+speakup@lfdr.de>; Tue, 06 May 2025 14:29:28 -0400 (EDT)
X-Original-To: speakup@linux-speakup.org
Delivered-To: speakup@linux-speakup.org
Received: by befuddled.reisers.ca (Postfix, from userid 65534)
	id 8E8C6382988; Tue, 06 May 2025 14:29:21 -0400 (EDT)
Received: from mail82.out.titan.email (mail82.out.titan.email [3.216.99.60])
	by befuddled.reisers.ca (Postfix) with ESMTPS id 59910382966
	for <speakup@linux-speakup.org>; Tue, 06 May 2025 14:29:21 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
	by smtp-out.flockmail.com (Postfix) with ESMTP id 7273960505;
	Tue,  6 May 2025 18:29:20 +0000 (UTC)
DKIM-Signature: a=rsa-sha256; bh=LtWmUtqh3k+yAtPZFgj/eVLo/B1ekSYnHRV/CRYMtHM=;
	c=relaxed/relaxed; d=t39smtp-sign001.email;
	h=from:cc:subject:message-id:to:date:references:mime-version:reply-to:from:to:cc:subject:date:message-id:reply-to:references:in-reply-to;
	q=dns/txt; s=titan1; t=1746556160; v=1;
	b=OaDbSKbCvb/fnaDFZLPYsJ6QXaFdHlfwkd69z6oTJWFNuAG9c+4UT85Gb+54VS3aDcqi7GRw
	cvlZpcTMppQEY2phGNF1mxO1IOhsyz9NDdP3otxmXgF8ZO/YFUQwpKORYZT6FFWXw2dxSX8kiGW
	rl3hjOitqAtIxuruJfr8nu+0=
Received: from nucwin10 (unknown [140.228.165.201])
	by smtp-out.flockmail.com (Postfix) with ESMTPA id A98076004C;
	Tue,  6 May 2025 18:29:19 +0000 (UTC)
Message-ID: <00ef01dbbeb4$c7bc51c0$01ffa8c0@nucwin10>
...
X-Titan-Src-Out: 1746556160221748137.5242.4524948755062935601@prod-use1-smtp-out1001.
X-CMAE-Score: 0
X-CMAE-Analysis: v=2.4 cv=O7TDvA9W c=1 sm=1 tr=0 ts=681a5500
	a=sfY17wZm961WJQkZ7MXrtw==:117 a=sfY17wZm961WJQkZ7MXrtw==:17
	a=IkcTkHD0fZMA:10 a=MKtGQD3n3ToA:10 a=CEWIc4RMnpUA:10 a=hEK2XftRAAAA:8
	a=qPKtzgQbAAAA:8 a=Grqch3-7l6nPNZJC6DYA:9 a=QEXdDO2ut3YA:10
