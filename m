Return-Path: <speakup+bounces-1276-lists+speakup=lfdr.de@linux-speakup.org>
X-Original-To: lists+speakup@lfdr.de
Delivered-To: lists+speakup@lfdr.de
Received: from befuddled.reisers.ca (befuddled.reisers.ca [206.248.184.127])
	by mail.lfdr.de (Postfix) with ESMTP id 78C4BAACB09
	for <lists+speakup@lfdr.de>; Tue,  6 May 2025 18:32:24 +0200 (CEST)
Authentication-Results: befuddled.reisers.ca;
	dkim=pass (1024-bit key; unprotected) header.d=t39smtp-sign001.email header.i=@t39smtp-sign001.email header.a=rsa-sha256 header.s=titan1 header.b=HOI/usgL;
	dkim-atps=neutral
Received: by befuddled.reisers.ca (Postfix, from userid 65534)
	id A16E8382992; Tue, 06 May 2025 12:32:23 -0400 (EDT)
Received: from befuddled.reisers.ca (localhost [127.0.0.1])
	by befuddled.reisers.ca (Postfix) with ESMTP id 7E81238293B
	for <lists+speakup@lfdr.de>; Tue, 06 May 2025 12:32:23 -0400 (EDT)
X-Original-To: speakup@linux-speakup.org
Delivered-To: speakup@linux-speakup.org
Received: by befuddled.reisers.ca (Postfix, from userid 65534)
	id 7DF1038293C; Tue, 06 May 2025 12:32:16 -0400 (EDT)
Received: from mail98.out.titan.email (mail98.out.titan.email [54.147.227.70])
	by befuddled.reisers.ca (Postfix) with ESMTPS id 12990382527
	for <speakup@linux-speakup.org>; Tue, 06 May 2025 12:32:16 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
	by smtp-out.flockmail.com (Postfix) with ESMTP id 1DEB2140250;
	Tue,  6 May 2025 16:32:15 +0000 (UTC)
DKIM-Signature: a=rsa-sha256; bh=DOo8HO6cXTVOhoyMeOE9SrD1LX5yS6e1Tic+fr8S7yU=;
	c=relaxed/relaxed; d=t39smtp-sign001.email;
	h=references:subject:reply-to:to:cc:mime-version:message-id:date:from:from:to:cc:subject:date:message-id:reply-to:references:in-reply-to;
	q=dns/txt; s=titan1; t=1746549134; v=1;
	b=HOI/usgLo7jcfsKYcgUhTwt5NZocfgnLlYlELfvzR8fuv7hOPrwIYWRgVVwD8H22pwmPjCax
	Bez+4ZOKr8J8j+jvfZPdVYhGj0lJzqL99J8iLyCURZWNE6uN6N3+8P+JvqxJw6DzWlu8tRsuVjx
	UJ/33pW5c1SJHP+cZaSj2x/Y=
Received: from nucwin10 (unknown [140.228.165.201])
	by smtp-out.flockmail.com (Postfix) with ESMTPA id 5F3BD140592;
	Tue,  6 May 2025 16:32:14 +0000 (UTC)
Message-ID: <008c01dbbea4$6c522b80$01ffa8c0@nucwin10>
...
X-Titan-Src-Out: 1746549134879536872.32042.8546078863629990551@prod-use1-smtp-out1003.
X-CMAE-Score: 0
X-CMAE-Analysis: v=2.4 cv=fZxXy1QF c=1 sm=1 tr=0 ts=681a398e
	a=sfY17wZm961WJQkZ7MXrtw==:117 a=sfY17wZm961WJQkZ7MXrtw==:17
	a=IkcTkHD0fZMA:10 a=MKtGQD3n3ToA:10 a=CEWIc4RMnpUA:10 a=hEK2XftRAAAA:8
	a=qPKtzgQbAAAA:8 a=iLP1CRjZOBIFgQ-EWqoA:9 a=QEXdDO2ut3YA:10
