Return-Path: <speakup+bounces-995-lists+speakup=lfdr.de@linux-speakup.org>
X-Original-To: lists+speakup@lfdr.de
Delivered-To: lists+speakup@lfdr.de
Received: from befuddled.reisers.ca (befuddled.reisers.ca [206.248.184.127])
	by mail.lfdr.de (Postfix) with ESMTP id 5DC8574CB28
	for <lists+speakup@lfdr.de>; Mon, 10 Jul 2023 06:22:08 +0200 (CEST)
Authentication-Results: befuddled.reisers.ca;
	dkim=pass (1024-bit key; unprotected) header.d=t39smtp-sign002.email header.i=@t39smtp-sign002.email header.a=rsa-sha256 header.s=titan1 header.b=e0uTSTrC;
	dkim-atps=neutral
Received: by befuddled.reisers.ca (Postfix, from userid 65534)
	id E5444382587; Mon, 10 Jul 2023 00:22:07 -0400 (EDT)
Received: from befuddled.reisers.ca (localhost [127.0.0.1])
	by befuddled.reisers.ca (Postfix) with ESMTP id C0D1C38252C
	for <lists+speakup@lfdr.de>; Mon, 10 Jul 2023 00:22:07 -0400 (EDT)
X-Original-To: speakup@linux-speakup.org
Delivered-To: speakup@linux-speakup.org
Received: by befuddled.reisers.ca (Postfix, from userid 65534)
	id 15DB8382562; Mon, 10 Jul 2023 00:22:00 -0400 (EDT)
Received: from mail3.out.flockmail.com (mail3.out.flockmail.com [18.215.190.59])
	by befuddled.reisers.ca (Postfix) with ESMTPS id D7ECE38252C
	for <speakup@linux-speakup.org>; Mon, 10 Jul 2023 00:21:59 -0400 (EDT)
Received: from smtp-out.flockmail.com (localhost [127.0.0.1])
	by smtp-out.flockmail.com (Postfix) with ESMTP id 4474B10008E;
	Mon, 10 Jul 2023 04:21:56 +0000 (UTC)
Received: from nucwin10 (unknown [140.228.165.201])
	by smtp-out.flockmail.com (Postfix) with ESMTPA id BA39010004F;
	Mon, 10 Jul 2023 04:21:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
	d=t39smtp-sign002.email; s=titan1; t=1688962916;
	bh=V6rFUmtDDgNklPwQundhPOvvrfYFNEk9zXEX4TqqeL4=;
	h=Message-ID:Reply-To:From:To:Cc:References:Subject:Date:
	 MIME-Version:From:To:Cc:Subject:Message-ID;
	b=e0uTSTrCJa2cVpyV1p6ZvDW0dY68drMMPfPPsik62Ip9Jz4Ugh2ywKOGjV3chvUEM
	 S4f10zBaB5ISZEIS8iONK7FLke+fXLTyfHtD3yASVECdQ9KM9P/NPxtDfnqJYC0GsH
	 iYB6EL0ar5gfEov6reRPzl0/iWlSC64I837DuQRU=
Message-ID: <028601d9b2e6$0fcaa020$01ffa8c0@nucwin10>
...
X-Titan-Src-Out: 1688962916042203596.11573.1301789958531932870@prod-use1-smtp-out1002.
X-CMAE-Score: 0
X-CMAE-Analysis: v=2.4 cv=Wrftc/Tv c=1 sm=1 tr=0 ts=64ab8764
	a=sfY17wZm961WJQkZ7MXrtw==:117 a=sfY17wZm961WJQkZ7MXrtw==:17
	a=8nJEP1OIZ-IA:10 a=MKtGQD3n3ToA:10 a=P3K-DvM3-jgA:10 a=CEWIc4RMnpUA:10
	a=9_GH9xibAAAA:8 a=qPKtzgQbAAAA:8 a=8Ro6GKBAAAAA:8 a=PKo_0_7HunyDl9CB-HsA:9
...
>
>> I'm assuming that is the TTY settings, so serial, even though this 
>> computer has no real serial ports.
